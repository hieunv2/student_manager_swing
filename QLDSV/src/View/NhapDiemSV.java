...
public class NhapDiemSV extends  JPanel{
    ...
    public NhapDiemSV(){
      ...
      //  setLocationRelativeTo(null);
        ...
        cbxMaHocKy.addActionListener((ActionEvent e) -> {
            try {
                listTenMH  = new GiangVien_MonDayController().getMonDay(LoginController.maTK,cbxMaHocKy.getSelectedItem().toString());
                DSMD();
    ...
    private void createMainPanel() {
       ...
       // panel.setPreferredSize(new Dimension(1150, 900));
        ...
        jLabel1.setBounds(100, 100, 200, 30);
        add(jLabel1);
        ...
        jLabelMonHoc.setBounds(120, 200, 100, 30);
        add(jLabelMonHoc);
        ...
        cbxTenMH.setBounds(225, 200, 450, 30);
        add(cbxTenMH);
    ...
    private void btnEnterActionPerformed(ActionEvent evt) {    
        ResultSet rs = new GiangVien_MonDayController().listSV(LoginController.maTK, cbxMaHocKy.getSelectedItem().toString(), cbxTenMH.getSelectedItem().toString());
        if (rs != null) {            
            showDSSV_MH(rs);
        }
    }
        ...
        if(updateRow < 0){
         ...
         //   System.out.println(txtDiemQT.getText());
           ...
           //    String masv = new SinhVienController().getMaSV(txtHoTen.getText(),txtMSSV.getText());
               ...
               sv_mh.setMaGiangVien(LoginController.maTK);
               sv_mh.setId(id);                                    
               ...
               if (new SinhVien_MonHocController().CapNhatDiem(sv_mh)) {                 
                   ...
                   ResultSet result = new  GiangVien_MonDayController().listSV(LoginController.maTK, cbxMaHocKy.getSelectedItem().toString(),cbxTenMH.getSelectedItem().toString() );         
                    showDSSV_MH(result);
   ...
   /* 
    ...
    private void DSMD() {
        try {
            ...
            for (int i = 0; i < listTenMH.size(); i++) {
                cbxTenMH.addItem(listTenMH.get(i));
            }           
        } catch (java.lang.NullPointerException e) {
